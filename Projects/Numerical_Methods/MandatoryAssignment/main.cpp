...
// Libraries from Numerical Recipes
#include <nr3.h>
#include <svd.h>
#include <ludcmp.h>
#include <qrdcmp.h>
...
// Utility header provided in the Numerical Methods class
#include "utilities.h"
...
int main() {
    ...
    // Uses newtons method from roots_multidim.h to find roots for the four functions, for t = 1.2
